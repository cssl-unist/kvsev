...
int main (int argc, char **argv) {
     ...
     * TODO:
     * (1) Integrate flags to enable/disable Merkle Tree integration
     */
    //merkle = mt_create();
    //if (merkle == NULL) fprintf(stderr, "[SEV]\tFailed to initialize Merkle Tree!\n");
    //mt_delete(merkle_tree);
